...
model_path = r'C:\Studies\final2\best.pt'  # Replace with the actual path to your model
conf_threshold = 0.25
result_image_path = r'C:\Studies\final2\result_image.jpg'
labels_output_path = r'C:\Studies\final2\result.txt'  # Path to save the result image
...
def get_diseases():
    ...
    image_path = os.path.join(r'C:\Studies\final2', image_file.filename)
